...
window.marketLayout=(()=>{
  ...
  function mount(key,side){
    ...
    const section=document.createElement('details');section.className='market-section';section.dataset.section=side;
    // Every section keeps its own disclosure state while sharing the token's market.
