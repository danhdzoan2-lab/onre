...
if(typeof window!=='undefined'){
  ...
  function renderSellBooks(){
    ...
    for(const key of (layout?layout.keys():Object.keys(ASSETS))){
      ...
      view.market=market;view.details.hidden=(selectedAssets.size>0&&!selectedAssets.has(key))||!!(layout&&!layout.get(key).details.open);window.sellBookHealth.set(key,{open:view.details.open&&!view.details.hidden,checkedAt:view.checkedAt,error:!!view.error});
