...
assert.equal(run('formatInwardRange(band.low,band.high)'),'8.378%–9.144%');
assert.equal(run('formatInwardRange(8.95,10.15)'),'8.950%–10.150%');
assert.equal(run('formatInwardRange(8.9501,8.9509)'),'No valid 3-decimal value');
assert.equal(run('formatInwardRange(8.951,8.951)'),'8.951%–8.951%');
assert.equal(run('formatInwardRange(-0.1004,-0.0986)'),'-0.100%–-0.099%');
assert.equal(run('formatInwardRange(0,0)'),'0.000%–0.000%');
assert.equal(run('formatInwardRange(NaN,1)'),'—');
